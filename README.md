...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-beancount/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-beancount/actions/workflows/validate.yml)

Neovim tree-sitter queries for **beancount**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-beancount",
...
- [ ] Changes are scoped to `beancount` — do not include files for other languages
